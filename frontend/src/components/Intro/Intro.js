  ...
  return (
    <Container className="intro-container">
      ...
      <div className="right-content">
        ...
        <p className="right">
          As Magic Post is striving to be a true integrator of container logistics
          connecting and simplifying our customers' supply chain through global
          end-to-end solutions we just made our customers' life a lot easier. We
          are able to manage the entire product journey for them including
          Inland Services, Magic Post Customs Services, Ocean Freight, Warehouse
          Management and Distribution to name but a few.
        </p>
      </div>
    </Container>
  );
