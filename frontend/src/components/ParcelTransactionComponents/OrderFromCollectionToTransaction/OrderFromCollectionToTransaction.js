...
import { handleGetIncomingOrdersFromCollectionHub } from "../../../services/transactionServices";
import Loader from "../../Utils/Loader/Loader";
import ReactPaginate from "react-paginate";
import { FaAngleDoubleLeft, FaAngleDoubleRight } from "react-icons/fa";
import { useEffect, useState } from "react";

function OrderFromCollectionToTransaction({ itemsPerPage }) {
  ...
  const fetchData = async () => {
    ...
    const result = await handleGetIncomingOrdersFromCollectionHub(
      sort,
      parcelType
    );
