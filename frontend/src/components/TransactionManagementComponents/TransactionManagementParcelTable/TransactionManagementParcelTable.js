function TransactionManagementParcelTable({ orders, isIncoming }) {
  return (
    <table className="transaction-management-table">
      <thead>
        <tr>
          <th>#</th>
          <th>Parcel ID</th>
...
export default TransactionManagementParcelTable;
